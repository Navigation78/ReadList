  ...
  if (!book) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-24 text-center">
        ...
        <h2 className="font-display text-xl font-semibold text-stone-900 dark:text-stone-100">Book not found</h2>
    ...
    <div className="relative max-w-6xl mx-auto px-6 py-10 overflow-hidden">
      ...
      <section className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center mb-14">
        ...
        <div className="md:col-span-8 text-center md:text-left">
          ...
          <p className="text-xl text-stone-800 dark:text-stone-300 mb-6">by {book.author}</p>

          <div className="flex flex-wrap justify-center md:justify-start gap-6 mb-8">
            {book.published_year && (
              <div className="flex flex-col">
                <span className="text-xs font-medium text-stone-600 dark:text-stone-400">Published</span>
                <span className="font-display font-semibold text-stone-900 dark:text-stone-100">{book.published_year}</span>
              </div>
            )}
            {book.page_count && (
              <>
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-medium text-stone-600 dark:text-stone-400">Pages</span>
                  <span className="font-display font-semibold text-stone-900 dark:text-stone-100">{book.page_count}</span>
                </div>
              </>
            )}
            {book.isbn && (
              <>
                <div className="w-px h-10 bg-stone-200 hidden md:block" />
                <div className="flex flex-col">
                  <span className="text-xs font-medium text-stone-600 dark:text-stone-400">ISBN</span>
                  <span className="font-display font-semibold text-stone-900 dark:text-stone-100">{book.isbn}</span>
                </div>
              </>
            )}
          </div>
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        {book.description && (
          <div className="md:col-span-2 bg-white dark:bg-stone-900 rounded-[2.5rem] p-8 shadow-[0_20px_50px_rgba(225,225,245,0.4)] h-fit">
            <h2 className="font-display text-lg font-semibold text-stone-900 dark:text-stone-100 mb-4 flex items-center gap-2">
        ...
        <div className={`flex flex-col gap-6 ${!book.description ? 'md:col-span-3' : ''}`}>
          ...
          {book.status === 'currently_reading' && book.page_count && (
            <div className="bg-rose-50/60 backdrop-blur-sm border border-white rounded-[2.5rem] p-7 shadow-[0_20px_50px_rgba(248,200,220,0.35)]">
              <div className="flex justify-between items-center mb-5">
                <h3 className="font-display font-semibold text-stone-900 dark:text-stone-100">Reading Progress</h3>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-end mb-2">
                  ...
                  <span className="text-xs text-stone-800 dark:text-stone-300">{currentPage} / {book.page_count} pages</span>
                </div>
              ...
              <form onSubmit={handleUpdateProgress} className="flex flex-col gap-3">
                <label className="text-xs font-medium text-stone-800 dark:text-stone-300 ml-1">Update current page</label>
                <div className="relative">
                  <input
                    type="number"
                    min="0"
                  ...
                  <button
                    ...
                    className="absolute right-1.5 top-1.5 w-8 h-8 rounded-lg bg-rose-500 text-white flex items-center justify-center hover:bg-rose-600 disabled:opacity-50 transition"
                  >
                    <Check size={14} />
                  </button>
                </div>
          ...
          <div className="bg-white dark:bg-stone-900 rounded-[2.5rem] p-7 shadow-[0_20px_50px_rgba(225,225,245,0.4)]">
            <h3 className="font-display font-semibold text-stone-900 dark:text-stone-100 mb-5">Timeline</h3>
            <div className="relative ml-2 space-y-6">
              ...
              <div className="relative pl-8">
                ...
                <p className="text-sm font-semibold text-stone-900 dark:text-stone-100">Added to Library</p>
              ...
              {book.started_at ? (
                <div className="relative pl-8">
                  ...
                  <p className="text-sm font-semibold text-stone-900 dark:text-stone-100">Started Reading</p>
                  <p className="text-xs text-stone-600 dark:text-stone-400">
                ...
                <div className="relative pl-8 opacity-40">
                  ...
                  <p className="text-sm font-semibold text-stone-800 dark:text-stone-300">Started Reading</p>
                  <p className="text-xs text-stone-600 dark:text-stone-400">Not started yet</p>
                </div>
              )}
              ...
              {book.finished_at ? (
                <div className="relative pl-8">
                  ...
                  <p className="text-sm font-semibold text-stone-900 dark:text-stone-100">Finished</p>
                  <p className="text-xs text-stone-600 dark:text-stone-400">
                ...
                <div className="relative pl-8 opacity-40">
                  <div className="absolute left-0 top-1 w-4 h-4 rounded-full bg-stone-200 ring-4 ring-white" />
                  <p className="text-sm font-semibold text-stone-800 dark:text-stone-300">Finished Reading</p>
                  <p className="text-xs text-stone-600 dark:text-stone-400">TBD</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="flex flex-col gap-2">
          {['currently_reading', 'finished', 'want_to_read'].map((s) => {
            ...
            return (
              ...
              >
                <Icon size={18} className={active ? `text-${meta.tint}-600` : 'text-stone-600 dark:text-stone-400'} />
